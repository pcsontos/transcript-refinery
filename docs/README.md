...
| [0003](<./decisions/0003-ingest-sorrend.md>) | melyik forrás az első | a Pinchflat letöltési mappája, nem az URL |
| [0004](<./decisions/0004-koltsegplafon.md>) | költségkorlát | két réteg: LiteLLM és alkalmazás |
| [0005](<./decisions/0005-transzkribalasi-ut.md>) | transzkribálás | egyetlen út: lokális `whisper.cpp` |
